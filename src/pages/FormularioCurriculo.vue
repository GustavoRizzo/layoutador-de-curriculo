    ...
    <form class="form" @submit.prevent="gravar()">
        ...
        <div class="dados-pessois">
            ...
            <div class="form-group">
                ...
                <input type="date" id="dataNascimento" class="form-control" required v-model=infoPessoais.dataNascimento />
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            infoPessoais: new InformacoesPessoais()
        }
    },
    methods: {
        gravar() {
